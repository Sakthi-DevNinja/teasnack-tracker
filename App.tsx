...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-tea-100">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-gray-800 tracking-tight">
              Tea<span className="text-tea-600">Desk</span>
            </h1>
          </div>
      ...
      {/* Main Content */}
      <main className="min-h-[calc(100vh-139px)] max-w-5xl mx-auto px-4 sm:px-6 py-8">
        {currentView === "entry" && (
      ...
      <footer className="max-w-5xl mx-auto px-6 py-8 text-center text-gray-400 text-sm print:hidden">
        <p>
          &copy; {new Date().getFullYear()} Tea
          <span className="text-tea-600">Desk</span>. Designed with care.
        </p>
      </footer>
    </div>
  );
